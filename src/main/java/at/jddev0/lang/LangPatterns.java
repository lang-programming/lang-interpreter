...
final class LangPatterns {
	...
	public static final Pattern OPERATOR_METHOD_NAME = Pattern.compile("op:((len|deepCopy|inc|dec|pos|inv|not)|" +
			...
			"(getItem|setItem))");
	/**
	 * RegEx: "<code>to:(char|int|long|float|bool|number)</code>"
	 */
	public static final Pattern CONVERSION_METHOD_NAME = Pattern.compile("to:(char|int|long|float|bool|number)");
	/**
