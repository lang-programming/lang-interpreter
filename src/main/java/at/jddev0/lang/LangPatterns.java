...
final class LangPatterns {
	...
	public static final Pattern OPERATOR_METHOD_NAME = Pattern.compile("op:((len|deepCopy|inc|dec|pos|inv|not|abs)|" +
			...
			"isEquals|isStrictEquals|isLessThan|isGreaterThan))|(getItem|setItem))");
	/**
	...
	/**
	 * RegEx: "<code>class (\$|&)\w+\s*(<.*>\s*)?\{</code>"
	 */
	public static final Pattern PARSING_CLASS_DEFINITION = Pattern.compile("class (\\$|&)\\w+\\s*(<.*>\\s*)?\\{");
	/**
